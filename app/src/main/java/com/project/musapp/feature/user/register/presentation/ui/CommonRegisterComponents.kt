...
fun RegisterScreenButton(
    ...
    val isFirstScreenButtonEnabled =
        viewModel.isFirstResgisterScreenButtonEnabled.observeAsState(initial = false).value

    val isLastScreenButtonEnabled =
        viewModel.isLastResgisterScreenButtonEnabled.observeAsState(initial = false).value
